...
<%@ page import="com.example.demo.domain.Music" %>
...
<div class="container mt-5">
    <h2 class="section-heading mb-4">Music Playlist</h2>
    <div class="row">
        <% 
            List<Music> musicList = (List<Music>) request.getAttribute("playlist");
            if (musicList != null && !musicList.isEmpty()) {
                for (Music trackList : musicList) {
                    byte[] musicBytes = trackList.getMusic();
                    String music = Base64.getEncoder().encodeToString(musicBytes);
        %>
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="artist-container">
                <div class="artist-name"><%= trackList.getName()%> - <%=trackList.getTitle()%></div>
                <div class="music">
                    <audio controls>
                ...
                <div class="music-id">Music ID: <%= trackList.getId() %></div>
            </div>
        </div>
        <% 
                }
